...
INSERT INTO analyses (analysis_type, sample_date, result, status, doctor_id, patient_id) VALUES
('Общий анализ крови', DEFAULT, 'Нормально', 'Завершен', 1, 1),
('Анализ на сахар', DEFAULT, 'Нормально', 'Завершен', 1, 2);
...
INSERT INTO documents (document_type, creation_date, content, status, doctor_id, patient_id) VALUES
('Медицинская справка', DEFAULT, 'Справка о болезни', 'Активен', 1, 1),
('Рекомендации', DEFAULT, 'Рекомендации по лечению', 'Активен', 2, 2);
